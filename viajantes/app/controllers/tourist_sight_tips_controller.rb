class TouristSightTipsController < ApplicationController
  ...
  def edit
    ...
    @tourist_sight = @tourist_sight_tip.tourist_sight
  ...
  def create
    @tourist_sight_tip = TouristSightTip.new(params[:tourist_sight_tip])
    @tourist_sight_tip.tourist_sight = TouristSight.find(params[:tourist_sight_id])
    @tourist_sight_tip.user = current_user
  ...
  def update
    ...
    respond_to do |format|
      if @tourist_sight_tip.update_attributes(params[:tourist_sight_tip])
