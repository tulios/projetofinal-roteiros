INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (2, 'Catetinho', 'Km 0 da BR 040, Trevo do Gama, Zona 0', 'Telefone: (61) 3338-8694 / 3338-8803

Simples e com estrutura toda em madeira, o Catetinho foi a primeira moradia presidencial em Brasília. A idéia da construção surgiu de uma conversa entre amigos. Enquanto o músico Dilermando Reis sugeria o nome – uma alusão ao Palácio do Catete, antiga residência do presidente no Rio de Janeiro – Oscar Niemeyer esboçou o projeto em um guardanapo.
...
Em 1959, o Catetinho foi tombado pelo Instituto do Patrimônio Histórico e Artístico Nacional (Iphan). Hoje, o espaço não é apenas um ponto turístico. Visitar o Catetinho é como ter uma aula de história sobre a capital do Brasil e sobre JK. A casa está restaurada e é possível ver objetos pessoais do ex-presidente, como seu chapéu marrom e um pijama de seda.', 2975, 1, 2, '2009-08-26 23:33:06.512178', '2009-08-26 23:33:41.796611');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (1, 'Catedral Metropolitana', 'Esplanada dos Ministérios, Eixo Monumental – Leste', 'Fone: (61) 3224-4073
Período de visitação: Diariamente, das 8h às 18h

Patrimônio Histórico e Artístico Nacional, a Catedral Metropolitana de Brasília é considerada um marco na história da arquitetura e da engenharia brasileira. A obra de Oscar Niemeyer, inaugurada em 1967, pouco lembra as igrejas tradicionais – principalmente pela forma circular.
...
Além do ousado projeto arquitetônico, este templo também guarda importantes peças e obras de arte, como o altar-mor, doado pelo Papa Paulo VI, a Via-Sacra, de Di Cavalcanti, e os quatro evangelistas, de Alfredo Ceschiatti, cada um com três metros de altura.', 2975, 1, 3, '2009-08-26 23:31:13.703233', '2009-08-26 23:31:45.721473');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (3, 'Centro de Convenções Ulysses Guimarães', 'Eixo Monumental - SDC (Setor de Divulgação Cultural), entre a Torre de TV e o Memorial JK', 'Fone: (61) 3325-6378
Período de visitação: Segunda a sexta-feira, das 9h às 12h e das 14h às 18h

De frente para a Esplanada dos Ministérios e a poucos minutos do núcleo das decisões políticas e econômicas, está um dos mais modernos espaços para eventos do País. Reinaugurado em 2005 após uma grande reforma, o Centro de Convenções Ulysses Guimarães tem 54 mil m² de área total. É três vezes maior do que o prédio original, construído na década de 1970.
...
O Centro de Convenções Ulysses Guimarães tem ajudado Brasília a fortalecer sua vocação para o turismo de negócios. Confira a agenda de eventos. Com um projeto arquitetônico ousado, o espaço também se tornou uma atração para qualquer visitante da capital.', 2975, 1, 2, '2009-08-26 23:34:54.482235', '2009-08-26 23:35:11.481827');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (5, 'Concha Acústica', 'Orla do Lago Paranoá - Setor de Hotéis e Turismo Norte', 'Fone: (61) 3306-1065
Período de visitação: Todos os dias, das 8h às 19h


Quem passa pelas margens do Lago Paranoá fica admirado com as formas da Concha Acústica. Projeto de Oscar Niemeyer inaugurado em 1969, o desenho parece se integrar perfeitamente à paisagem natural da região.
...
Torça para estar em Brasília em dia de espetáculo na Concha. Se isso não acontecer, você mesmo pode testar a acústica do local.', 2975, 1, 2, '2009-08-26 23:38:09.410923', '2009-08-26 23:38:25.5007');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (6, 'Congresso Nacional', 'Praça dos Três Poderes', 'Fone: (61) 3216-1771 / 3216-1772 
Período de visitação: Todos os dias do ano, inclusive feriados, das 9h às 17h (visitas guiadas de 30 em 30 minutos, a partir de 9h30). 

Cartão postal de Brasília, o Congresso Nacional é mais do que a sede do Poder Legislativo. Símbolo da arquitetura de Oscar Niemeyer, a obra se destaca na paisagem plana e organizada da cidade. Além da beleza, o desenho do projeto desafiou os engenheiros da época.
...
Diariamente, são realizadas visitas monitoradas ao Congresso Nacional. Não deixe de passar pelos Salões Negro, Verde e Nobre, os plenários e as galerias. Se der sorte, você pode assistir a uma sessão da Câmara ou do Senado e até encontrar o seu candidato das últimas eleições. Do lado de fora, os jardins projetados por Burle Marx são uma atração a parte. Valem a pena conhecer.', 2975, 1, 2, '2009-08-26 23:40:12.225722', '2009-08-26 23:40:23.28858');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (7, 'Ermida Dom Bosco', 'SHDB – Parque Dom Bosco – QL 30', 'Telefone: (61) 3367-4505

A pequena igreja às margens do Lago Paranoá foi construída em homenagem ao santo São João Melchior Bosco. Reza a lenda que Dom Bosco sonhou com a criação de uma cidade onde hoje está localizada Brasília.
...
Se tiver disposição, aproveite a ida ao local para fazer trilhas e caminhadas pelo parque. O pôr-do-sol é uma atração à parte.', 2975, 1, 2, '2009-08-26 23:41:48.462913', '2009-08-26 23:41:58.813199');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (4, 'Complexo Cultural da República João Herculino', 'Setor Cultural Sul, Lote 2, próximo à Rodoviária do Plano Piloto - Zona 0', 'Fone: (61) 3325-6410 / (21) 3325-6257 / (21) 3325-6237
Período de visitação: Museu - Terça a domingo, das 9h às 18h30 / Biblioteca – Ligar para agendar. 

Depois de quase meio século, saíram do papel dois projetos de Oscar Niemeyer desenhados na época da construção de Brasília. No final de 2006, foram inaugurados o Museu Nacional Honestino Guimarães e a Biblioteca Nacional Leonel de Moura Brizola, que integram o Complexo Cultural da República João Herculino. 
...
A biblioteca, com acervo ainda em formação, tem estrutura para se tornar uma das mais modernas do País, principalmente no quesito inclusão digital. Comporta mais de 500 mil volumes impressos e 200 microcomputadores com acesso à internet e aos acervos de outras bibliotecas brasileiras.', 2975, 1, 4, '2009-08-26 23:36:54.989795', '2009-08-26 23:49:41.05214');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (9, 'Jardim Botânico de Brasília', 'SMDB conjunto 12, Lago Sul', 'Telefone: (61) 3366-4482

O Jardim Botânico é parada obrigatória para quem visita Brasília pela primeira vez. A fauna e a flora típicas do cerrado reservam algumas surpresas. Diferentemente de todos os outros parques do País, o jardim não é formado por plantas de várias regiões, e sim pela vegetação natural da região.
...
Para quem gosta de ler ao ar livre, o parque conta ainda com uma biblioteca ecológica, inaugurada em março de 2007. O espaço é destinado às crianças.', 2975, 1, 2, '2009-08-26 23:44:50.983122', '2009-08-26 23:45:16.686386');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (8, 'Espaço Lúcio Costa', 'Praça dos Três Poderes - subsolo', 'Fone: (61) 3325-6163
Período de visitação: Terça a domingo e feriados, das 9h às 18h

Quem chega a Brasília pela primeira vez quer entender como a capital foi concebida. Para isso, o melhor é visitar o Espaço Lúcio Costa. Com uma maquete de 170 m² do Plano Piloto e cópias de seus croquis e relatório oficial, o local é um paraíso para quem gosta de urbanismo e arquitetura.
...
A maquete do Plano Piloto já foi exposta em outras cidades do Brasil e no exterior. Criada em 1988, ela está no Espaço Lúcio Costa desde a inauguração do local, em 1992. Neste protótipo, há um sistema de som que transmite informações em quatro idiomas. Ao lado, fica uma maquete tátil, com legendas em Braille.', 2975, 1, 3, '2009-08-26 23:43:33.519198', '2009-08-26 23:44:02.752564');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (11, 'Memorial dos Povos Indígenas', 'Eixo Monumental Oeste – Praça do Buriti', 'Fone: (61) 3344-1155
Período de visitação: Terça a sexta-feira, das 9h às 18h; sábados, domingos e feriados, das 10h às 18h

Em pleno Eixo Monumental uma construção na forma de espiral guarda a história de quem habitavam o território brasileiro antes da chegada dos portugueses. O Memorial dos Povos Indígenas foi inspirado nas malocas dos índios e em suas tradições. Por isso, ao projetar o museu, Oscar Niemeyer criou um pátio no meio do prédio e sugeriu que lá fossem realizados os eventos da casa, assim como os rituais no centro de uma aldeia.
...
Somente depois de muitas manifestações e de fechar as portas diversas vezes, em 1999 o espaço se tornou, definitivamente, o Memorial dos Povos Indígenas. Essa conquista foi motivada por um fato que você deve lembrar: dois anos antes, alguns jovens haviam queimado o índio Gaudino Pataxó. O corpo dele foi velado no museu e serviu de alerta para a necessidade de criar uma cultura de respeito aos índios.', 2975, 1, 2, '2009-08-26 23:47:21.780769', '2009-08-26 23:47:28.73257');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (12, 'Palácio da Alvorada', 'Via Presidencial', 'Telefone: (61) 3411-2042

Construído para ser a residência oficial do presidente, o Palácio da Alvorada foi inaugurado em 1958. O projeto de Oscar Niemeyer ficou pronto em apenas sete meses e tornou-se um marco da arquitetura moderna.
...
Além da arquitetura, outra grande atração é o famoso “Poço dos desejos”. Lembre-se de fazer o seu pedido e jogar uma moeda no canal. ', 2975, 1, 2, '2009-08-26 23:48:18.505998', '2009-08-26 23:48:25.718976');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (13, 'Palácio do Planalto', 'Praça dos Três Poderes - Zona 0', 'Fone: (61) 3411-2317/ 3411-2318
Período de visitação: domingo, das 9h30 às 14h30. Não funciona em feriados. Grupos escolares precisam agendar a visita.

A rampa por onde já passaram tantos Presidentes e Chefes de Estado pode ser escalada por cidadãos comuns. Aos domingos, dia de visita no Palácio do Planalto, você pode conhecer este e outros importantes cenários de decisões da política brasileira.
...
Alguns cômodos ficarão apenas na sua lembrança – no terceiro andar, não é permitido fotografar. Lá estão os locais que mais despertam a curiosidade do público – como o Gabinete da Presidência da República e a Sala de Audiências. ', 2975, 1, 3, '2009-08-26 23:49:11.710032', '2009-08-26 23:49:28.042373');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (10, 'Jardim Zoológico de Brasília', 'Av. das Nações - Via L4 Sul', 'Fone: (61) 3345-3280
Período de visitação: De terça-feira a domingo, das 9h às 17h

Um dos mais conhecidos do Brasil, o Jardim Zoológico de Brasília tem ambientes semelhantes aos de selvas e florestas. Numa área de 140 hectares, lagos, ilhas, pátios e muitas árvores tentam imitar o habitat natural de mais de 250 espécies – aproximadamente 1.300 animais. Nesta variedade, estão bichos exóticos, como o faisão, e outros ameaçados de extinção, como a jaguatirica.
...
Inaugurado em 1957, o Zoológico de Brasília é bem mais que um lugar de visitação. A estrutura do local inclui teatro de arena, auditório, biblioteca e museu e laboratório de taxidermia. Ao seu lado está o Santuário de Vida Silvestre do Riacho Fundo e o Parque das Aves. Os três espaços são administrados pela Fundação Pólo Ecológico de Brasília - FunPEB.', 2975, 1, 4, '2009-08-26 23:46:16.386106', '2009-08-26 23:50:00.088413');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (15, 'Pontão do Lago Sul', 'SHIS, QL10, LT. 1/33 - Pontão do Lago Sul', 'Telefone: (61) 3364-0580
E-mail: pontao@pontaodolagosul.com.br

Conhecido pela bela paisagem, o Pontão do Lago Sul é um dos locais mais freqüentados por quem procura bons restaurantes e um clima praiano.
...
Inaugurado em abril de 2002, o espaço com 134 mil m² e recebe cerca de 120 mil visitantes por mês. Apesar do grande movimento, não se preocupe com estacionamento: são 1,5 mil vagas.', 2975, 1, 2, '2009-08-26 23:52:39.78083', '2009-08-26 23:52:56.510814');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (14, 'Parque da Cidade', 'Asa Sul de Brasília - entradas pelo eixo Monumental, setor de Indústria e Quadras 901, 906 e 910 Sul', 'Fone: (61) 3225-2451

Se você acha que uma praia faz falta em Brasília, vai ter uma boa surpresa ao ar livre. O Parque da Cidade – Sarah Kubitschek é um complexo de diversão com área equivalente a 420 hectares, localizado na Asa Sul. O espaço, público e gratuito, atende a todos os gostos e idades: além de duas ciclovias, tem parque infantil, lago com pedalinhos e caiaques, churrasqueiras, campos de futebol, kartódromo, campo de aeromodelismo, anfiteatro e estádio hípico.
...
Quem tem mais de 60 anos pode participar de aulas de Tai Chi Chuan, ioga e condicionamento físico. As atividades são gratuitas e acontecem de segunda a sexta, pela manhã.
Para ser criado, o Parque da Cidade contou com a experiência de três grandes nomes da área: Oscar Niemeyer (arquitetura), Burle Marx (jardins) e Lúcio Costa (urbanismo). Só por isso já dá para imaginar que a visita vale mesmo a pena.', 2975, 1, 6, '2009-08-26 23:50:51.302532', '2009-08-26 23:53:00.413932');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (17, 'Teatro Nacional', 'Setor Cultural Norte – Via N2', 'Fone: (61) 3325-6105
Período de visitação: Segunda a sexta-feira, das 15h às 17h30

Inaugurado em março de 1979, o Teatro Nacional Claudio Santoro é um projeto de Oscar Niemeyer e tem influência da arquitetura asteca. As obras, que começaram em 1960, foram realizadas em etapas. Enquanto o teatro não estava concluído, o local serviu de palco para concursos de beleza, bailes de carnaval, missas e eventos esportivos. Hoje, o teatro é o maior complexo da cidade destinado às artes. Além das salas de espetáculos Martins Pena, Alberto Nepomuceno e Villa-Lobos, o espaço conta ainda com uma galeria de artes plásticas. Ao visitar o local, fique atento aos jardins e às esculturas – “O Contorcionista”, de Alfredo Ceschiatti, e “O Pássaro” – que dão um toque especial ao ambiente. Em forma de pirâmide, o teatro também é espaço para boatos assombrados. Dizem que, durante a madrugada, funcionários já ouviram vozes e sons dos pianos das salas.', 2975, 1, 2, '2009-08-26 23:55:25.254333', '2009-08-26 23:55:32.071937');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (16, 'Santuário Dom Bosco', 'W3 Sul, Quadra 702', 'Telefone: (61) 3223-6542
E-mail: contato@santuariodombosco.org.br
...
Quem quiser assistir a uma missa deve se programar para não perder os horários. As cerimônias acontecem às 7h e às 18h, de segunda a sábado, e às 8h, às 11h, às 18h e às 19h30, no domingo. A igreja tem capacidade para 1,2 mil pessoas. ', 2975, 1, 2, '2009-08-26 23:54:02.803854', '2009-08-26 23:54:11.434982');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (19, 'Torre de televisão', 'Eixo Monumental – Lado Oeste – Canteiro Central', 'Fone: (61) 3322-6611
Período de visitação: Todos os dias, das 9h às 18h

Para entender o Plano Piloto, pegue um mapa de Brasília e vá ao mirante da Torre de televisão. De uma plataforma de 75 metros de altura, é possível ver o eixo e as asas do avião que dá forma à cidade. No meio da planície, o destaque é a Esplanada dos Ministérios, com o Congresso Nacional ao fundo.
...
Para subir ao mirante, não se preocupe com o cansaço, pois há um elevador à sua disposição. Antes de chegar ao ponto mais alto, você pode visitar o Museu Nacional de Gemas. Instalado na plataforma mais baixa da torre, a 25 metros do chão, o local guarda uma enorme variedade de pedras brasileiras, preciosas e semi-preciosas.', 2975, 1, 2, '2009-08-26 23:57:20.159541', '2009-08-26 23:57:31.801792');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (18, 'Legião da Boa Vontade-LBV', 'SGAS 915 Lotes 75/76', 'Fone: (61) 3245-1070
Período de visitação: Todos os dias, em qualquer horário

Esqueça dogmas ou extremismos religiosos. O Templo da Boa Vontade não foi feito para um grupo específico. Ao contrário: desde que foi inaugurado, em 1989, seu objetivo é ser o ponto de encontro da espiritualidade, cultura, arte, ecologia e medicina espiritual. O prédio foi construído pela Legião da Boa Vontade (LBV).
...
Além da meditação, você também pode visitar os espaços anexos à pirâmide, onde estão uma galeria de arte, o Memorial Alziro Zarur, a Sala Egípcia, o Salão Nobre, os jardins subterrâneos e o Parlamento Mundial da Fraternidade Ecumênica, construído em 1994 para abrigar conferências da LBV.', 2975, 1, 3, '2009-08-26 23:56:16.844433', '2009-08-26 23:56:44.940254');
INSERT INTO tourist_sights (id, name, address, description, city_id, user_id, hits, created_at, updated_at) VALUES (20, 'Parque Nacional de Brasilia Água Mineral', 'Rodovia BR - 040 - SMU - Via EPIA', 'Fone: (61) 3465-2013
Período de visitação: Diariamente, das 8h às 16h

A apenas 10 km do centro do Plano Piloto há uma paisagem inimaginável em qualquer grande cidade: um espaço com nada menos que 30 mil hectares de árvores, trilhas e duas piscinas naturais de águas cristalinas. É o Parque Nacional de Brasília, mais conhecido como Água Mineral. Quando o assunto é qualidade de vida, este é um dos destinos preferidos dos moradores da capital.
