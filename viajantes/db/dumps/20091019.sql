...
SELECT pg_catalog.setval('destinations_id_seq', 1, false);
...
SELECT pg_catalog.setval('roadmaps_id_seq', 1, false);
...
SELECT pg_catalog.setval('shop_evaluations_id_seq', 1, false);
...
SELECT pg_catalog.setval('shops_id_seq', 5, true);
...
SELECT pg_catalog.setval('tourist_sight_evaluations_id_seq', 1, false);
...
SELECT pg_catalog.setval('tourist_sight_tags_id_seq', 33, true);
...
SELECT pg_catalog.setval('tourist_sight_tips_id_seq', 1, false);
...
SELECT pg_catalog.setval('tourist_sights_id_seq', 21, true);
...
Para ser criado, o Parque da Cidade contou com a experiência de três grandes nomes da área: Oscar Niemeyer (arquitetura), Burle Marx (jardins) e Lúcio Costa (urbanismo). Só por isso já dá para imaginar que a visita vale mesmo a pena.', 2975, 1, 18, '2009-08-26 23:50:51.302532', '2009-10-17 00:36:38.846927');
...
Quem quiser assistir a uma missa deve se programar para não perder os horários. A igreja tem capacidade para 1,2 mil pessoas. ', 2975, 1, 7, '2009-08-26 23:54:02.803854', '2009-10-17 00:36:41.21395');
...
Alguns cômodos ficarão apenas na sua lembrança – no terceiro andar, não é permitido fotografar. Lá estão os locais que mais despertam a curiosidade do público – como o Gabinete da Presidência da República e a Sala de Audiências. ', 2975, 1, 6, '2009-08-26 23:49:11.710032', '2009-10-17 00:37:01.815712');
...
Para quem gosta de ler ao ar livre, o parque conta ainda com uma biblioteca ecológica, inaugurada em março de 2007. O espaço é destinado às crianças.', 2975, 1, 5, '2009-08-26 23:44:50.983122', '2009-10-17 00:37:06.150594');
