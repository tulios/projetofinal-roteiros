...
SELECT pg_catalog.setval('event_evaluations_id_seq', 1, true);
...
SELECT pg_catalog.setval('shop_evaluations_id_seq', 19, true);
...
SELECT pg_catalog.setval('shop_tips_id_seq', 1, true);
...
SELECT pg_catalog.setval('shops_id_seq', 71, true);
...
SELECT pg_catalog.setval('tips_id_seq', 13, true);
...
SELECT pg_catalog.setval('tourist_sight_evaluations_id_seq', 45, true);
...
SELECT pg_catalog.setval('tourist_sights_id_seq', 72, true);
...
INSERT INTO roadmaps VALUES (4, 'Tocantins lugar calmo', 'É uma das 27 unidades federativas do Brasil, sendo seu mais novo estadoO relevo apresenta chapadas ao centro, ao sul e ao leste, a Serra Geral a sudeste, a Serra Traíras (ou das Palmas) ao sul, e a planície do Araguaia, com a ilha do Bananal, nas regiões norte, oeste e sudoeste. São importantes o rio Tocantins, o rio Araguaia, o rio do Sono, o rio das Balsas e o rio Paranã. O clima é tropical.Um lugar maravilhoso para se curti ferias calmas com bastante diversão.', false, 409, 7, '2009-11-08 20:09:28.626564', '2009-11-08 20:09:28.626564');
...
INSERT INTO shops VALUES (4, 'Bay Park', 'SHTN trecho 02 lote 05 Setor de Clubes Esportivos Norte', '(61) 3037-3000', '(61) 3306-3000', 'baypark@baypark.com.br', 'http://www.baypark.com.br/', 'É um parque aquático e um resort hotel. O parque aquático, nesta área, conta com piscina de ondas, toboáguas e lanchonete.', '', 'hotel, resort, parque, parque aquatico, piscina', 14, 2975, 1, NULL, '2009-08-27 00:39:35.76565', '2009-11-09 05:20:13.659212');
...
INSERT INTO shops VALUES (71, 'Roteiros', '103 Norte Avenida LO 2 lt 37 s 3 cj 4 Bairro: Plano Diretor Norte', '(63) 3215-8717', '', NULL, '', '', '', 'Hotel', 3, 409, 7, 71, '2009-11-08 23:16:45.300999', '2009-11-09 06:06:52.622944');
...
Lazer
    ...
    * Piscina
    * Fitness Center
    * Sauna', 'hotel', 12, 2975, 1, NULL, '2009-08-27 00:41:07.822205', '2009-11-08 13:05:50.267217');
...
', 2728, 7, 2, '2009-11-08 11:30:59.856242', '2009-11-08 11:32:38.177614');
...
', 1233, 7, 3, '2009-11-06 18:43:23.059763', '2009-11-06 19:00:59.497516');
...
Para ser criado, o Parque da Cidade contou com a experiência de três grandes nomes da área: Oscar Niemeyer (arquitetura), Burle Marx (jardins) e Lúcio Costa (urbanismo). Só por isso já dá para imaginar que a visita vale mesmo a pena.', 2975, 1, 37, '2009-08-26 23:50:51.302532', '2009-11-06 19:01:16.924322');
