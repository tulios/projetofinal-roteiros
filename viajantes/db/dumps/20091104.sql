...
SELECT pg_catalog.setval('evaluations_id_seq', 24, true);
...
SELECT pg_catalog.setval('event_evaluations_id_seq', 1, false);
...
SELECT pg_catalog.setval('event_tips_id_seq', 1, false);
...
SELECT pg_catalog.setval('roadmaps_id_seq', 3, true);
...
SELECT pg_catalog.setval('shop_evaluations_id_seq', 7, true);
...
SELECT pg_catalog.setval('shop_tips_id_seq', 1, false);
...
SELECT pg_catalog.setval('shops_id_seq', 30, true);
...
SELECT pg_catalog.setval('tips_id_seq', 5, true);
...
SELECT pg_catalog.setval('tourist_sight_evaluations_id_seq', 17, true);
...
SELECT pg_catalog.setval('tourist_sight_tips_id_seq', 5, true);
...
SELECT pg_catalog.setval('tourist_sights_id_seq', 39, true);
...
INSERT INTO destinations VALUES (1, 100, '2009-10-22', '2009-10-25', 1, 1, 2975, '2009-10-21 08:21:04.471669', '2009-10-21 08:21:04.471669');
...
INSERT INTO roadmaps VALUES (1, 'teste', 'teste', false, 2975, 2, '2009-10-21 08:20:05.33117', '2009-10-21 08:20:05.33117');
...
Lazer
    ...
    * Piscina
    * Fitness Center
    * Sauna', 'hotel', 10, 2975, 1, NULL, '2009-08-27 00:41:07.822205', '2009-10-25 18:27:15.032395');
...
O Hotel Ritz Lagoa da Anta fica no bairro de Cruz da Almas, em frente à praia. A piscina do hotel é a maior dos hotéis de Alagoas, com pontes e partes rasas para as crianças.', 'Infra-estrutura: Clube Infantil, Fitness Center, Piscina, Piscina Infantil, Recreador, Restaurante, Sauna a vapor, Sauna Seca, Serviço de quarto 24h, Hidromassagem, Internet, Quadra de tênis, Lavanderia, Lojas, Cafeteria, Spa, Bar e Solário.', 'hotel, piscina, restaurante, sauna, internet', 5, 632, 2, 30, '2009-11-04 14:14:34.449105', '2009-11-04 15:33:36.735155');
...
', '', 'hotel', 2, 632, 7, 33, '2009-11-04 15:47:05.471673', '2009-11-04 15:48:48.31164');
...
', '', '', 2, 60, 7, NULL, '2009-11-04 18:26:38.447751', '2009-11-04 18:29:33.701103');
...
', 60, 7, 2, '2009-11-04 17:25:35.10463', '2009-11-04 22:51:03.907587');
...
', 22, 7, 7, '2009-11-02 20:02:58.521506', '2009-11-04 02:32:00.30862');
...
Para ser criado, o Parque da Cidade contou com a experiência de três grandes nomes da área: Oscar Niemeyer (arquitetura), Burle Marx (jardins) e Lúcio Costa (urbanismo). Só por isso já dá para imaginar que a visita vale mesmo a pena.', 2975, 1, 34, '2009-08-26 23:50:51.302532', '2009-11-04 13:36:47.306431');
...
Para quem gosta de ler ao ar livre, o parque conta ainda com uma biblioteca ecológica, inaugurada em março de 2007. O espaço é destinado às crianças.', 2975, 1, 6, '2009-08-26 23:44:50.983122', '2009-11-04 00:03:39.308527');
...
a maior atração é o passeio de jangada até a piscina natural que se forma na maré baixa entre arrecifes e bancos de areia, à 02 km da costa de Maceió. Nos finais de semana, Pajuçara ganha bares flutuantes, que servem bebidas e tira-gosto. ', 632, 7, 1, '2009-11-04 15:41:15.031124', '2009-11-04 15:41:15.435737');
INSERT INTO tourist_sights VALUES (3, 'Centro de Convenções Ulysses Guimarães', 'Eixo Monumental - SDC (Setor de Divulgação Cultural), entre a Torre de TV e o Memorial JK', '(61) 3325-6378', NULL, 'Segunda a sexta-feira, das 9h às 12h e das 14h às 18h', 'De frente para a Esplanada dos Ministérios e a poucos minutos do núcleo das decisões políticas e econômicas, está um dos mais modernos espaços para eventos do País. Reinaugurado em 2005 após uma grande reforma, o Centro de Convenções Ulysses Guimarães tem 54 mil m² de área total. É três vezes maior do que o prédio original, construído na década de 1970.
...
INSERT INTO users VALUES (7, 'raissa', 'rah_ornelas@hotmail.com', 'f', '1991-07-12', 2975, '83305bbe086e5e65a442ad37544ef87b3a94f06f', 'a879577153d6e8ff9fab97231701a9ab83662621', '2009-11-02 18:59:16.670594', '2009-11-03 19:10:14.137246', '2978f89d24d8471588dba5731c9b84d68317c196', '2009-11-17 21:10:13.993566');
...
INSERT INTO users VALUES (2, 'tulios', 'ornelas.tulio@gmail.com', 'm', '1987-12-15', 2975, 'ecb752f822b97a25b15debf3c9cba77403aa4c7e', 'fe35e23b36c0b2cad05402c35045419e07793abc', '2009-09-02 08:59:33.863789', '2009-10-15 20:38:19.18426', NULL, NULL);
